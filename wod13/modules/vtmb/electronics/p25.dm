...
/obj/machinery/p25transceiver
	...
	icon = 'wod13/modules/vtmb/icons/obj/radio.dmi'
		...
		if(active)
			...
			for(var/obj/item/p25radio/R in connected_radios)
				if(R.linked_network == p25_network)
					playsound(R, 'wod13/modules/vtmb/sound/effects/radiodestatic.ogg', 50, FALSE)
			...
			for(var/obj/item/p25radio/R in connected_radios)
				if(R.linked_network == p25_network)
					playsound(R, 'wod13/modules/vtmb/sound/effects/radioonn.ogg', 50, FALSE)
					for(var/mob/M in get_hearers_in_view(1, get_turf(R)))
...
/obj/machinery/p25transceiver/attackby(obj/item/W, mob/user, params)
	if(istype(W, /obj/item/p25radio))
		...
		playsound(src, 'wod13/modules/vtmb/sound/effects/radioonn.ogg', 25, FALSE)
	else
		return ..()
...
/obj/machinery/p25transceiver/proc/broadcast_to_network(message, network = src.p25_network, play_sound = 'wod13/modules/vtmb/sound/effects/radioclick.ogg', sound_volume = 30, check_dispatch = FALSE)
	if(!active)
		return FALSE
...
/obj/machinery/p25transceiver/police/proc/broadcast_emergency(obj/item/p25radio/police/source)
	...
	return broadcast_to_network(formatted, "police", 'wod13/modules/vtmb/sound/effects/radioalert.ogg', 100)
...
/obj/machinery/p25transceiver/police/proc/announce_crime(crime, atom/location)
	...
	if(should_announce)
		...
		broadcast_to_network(formatted, "police", 'wod13/modules/vtmb/sound/effects/radioclick.ogg', 10, TRUE)
...
/obj/item/p25radio/proc/check_signal()
	...
	if(currently_restricted && !in_restricted_area)
		...
		playsound(src, 'wod13/modules/vtmb/sound/effects/radiodestatic.ogg', 50, FALSE)
		...
		playsound(src, 'wod13/modules/vtmb/sound/effects/radioonn.ogg', 50, FALSE)
